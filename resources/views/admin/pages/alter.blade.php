...
<div class="card">
    <form action="{{ $actionUrl }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="card-body">
            <div class="row">
                <x-form-input name="page_name" type="text" label="Page Name" value="{!! $page->page_name !!}" placeholder="Enter Page name here" />

                <x-form-input name="page_seo_title" type="text" label="Page SEO Title" value="{!! $page->page_seo_title !!}" placeholder="Enter Page SEO Title here" />

                <x-form-input name="page_seo_description" type="text" label="Page SEO Description" value="{!! $page->page_seo_description !!}" placeholder="Enter Page SEO Description here" />
