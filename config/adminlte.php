...
return [
    ...
    */
    ...
    'use_route_url' => false,
    'dashboard_url' => env('ADMIN_PATH', 'webadmin'),
    'logout_url' => env('ADMIN_PATH', 'webadmin') . '/logout',
    'login_url' => env('ADMIN_PATH', 'webadmin') . '/login',
    'register_url' => '',
    'password_reset_url' => '',
    'password_email_url' => '',
    'profile_url' => false,
